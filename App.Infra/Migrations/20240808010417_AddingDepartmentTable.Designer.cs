...
namespace App.Infra.Migrations
{
    ...
    [Migration("20240808010417_AddingDepartmentTable")]
    partial class AddingDepartmentTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Domain.Entities.Department.DepartmentEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DepartmentEntityMemberEntity", b =>
                {
                    ...
                    b.ToTable("DepartmentEntityMemberEntity");
                });
            ...
            modelBuilder.Entity("DepartmentEntityMemberEntity", b =>
                {
                    b.HasOne("App.Domain.Entities.Department.DepartmentEntity", null)
                        .WithMany()
